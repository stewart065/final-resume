            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9">
                        ...
                        <div class="col-lg-5">
                            <div class="resume-base bg-danger maypaka user-dashboard-info-box p-4">
                                <div class="profile">
                ...
                <div class="col-lg-7">
                    <div class="resume-experience">
                        <div class="timeline-box">
                            ...
                            <a style="margin-left: 20px;"href="educadd.php">+</a>
                                ...
                                <div class="jobster-candidate-timeline">
                                    <div class="jobster-timeline-item">
                                        ...
                                        <br>
                                        <?php
                                               $sql="SELECT `title`, `year`, `school` FROM `educ`";
                                               $res=$con->query($sql);
                                               while($row = mysqli_fetch_object($res)){
                                                
                                         ?>
                                           <br>
                                            <h6 style="margin-left: 30px;"><?php echo $row->title?></h6>
                                            <h6 class="mb-20" style="margin-left: 30px;"><?php echo $row->year?></h6>
                                            <span style="margin-left: 30px;"><?php echo $row->school?></span><br>
                    ...
                    <div class="timeline-box mt-4">
                        <h5 class="resume-experience-title" style="margin-left: 20px;">Work &amp; Experience:</h5>
                        <a style="margin-left: 30px;" href="expradd.php">+</a>
                        <div class="jobster-candidate-timeline">
                            <div class="jobster-timeline-item">
                                 <div class="jobster-timeline-cricle">
                                    <i class="far fa-circle"></i>
                                ...
                                <?php
                                         $sql="SELECT`ComapnyName`, `Position`, `YearMonth`, `Experience` FROM `expr`";
                                         $res=$con->query($sql);
                                         while($row = mysqli_fetch_object($res)){
                                ?>
                                
                                    <br>
                                     <span style="margin-left: 30px;" class="jobster-timeline-time"><?php echo $row->YearMonth?></span>
                                     <h6  style="margin-left: 30px;"class="mb-2"><?php echo $row->ComapnyName?></h6>
                                     <span style="margin-left: 30px;">- <?php echo $row->Position?> </span>
                                     <p style="margin-left: 30px;" class="mt-2"><?php echo $row->Experience?></p>
                                     <br>
                    ...
                    <div class="timeline-box mt-2">
                        ...
                        <a style="margin-left: 30px;" href="crtfadd.php">+</a>
                         <div class="jobster-candidate-timeline">
                            <div class="jobster-timeline-item">
                                <div class="jobster-timeline-cricle">
                                     <i class="far fa-circle"></i>
                                ...
                                <?php 
                                         $sql="SELECT`Reference`, `title`, `comapnyname`, `Email` FROM `characterse`";
                                         $res=$con->query($sql);
                                         while($row = mysqli_fetch_object($res)){
                                ?>
                                ...
                                <br>
                                     <span style="margin-left: 30px;" class="jobster-timeline-time"><?php echo $row->Reference?></span>
                                     <h6  style="margin-left: 30px;"class="mb-2"><?php echo $row->comapnyname?></h6>
                                     <span style="margin-left: 30px;">- <?php echo $row->title?> </span>
                                     <p style="margin-left: 30px;" class="mt-2"><?php echo $row->Email?></p>
                                     <br>
